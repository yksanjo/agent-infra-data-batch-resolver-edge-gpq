# agent-infra-data-batch-resolver-edge-gpq

## Detailed Description

agent-infra-data-batch-resolver-edge-gpq is a iot-focused project that evaluates device telemetry and operational anomalies to improve fleet reliability and safety.  
